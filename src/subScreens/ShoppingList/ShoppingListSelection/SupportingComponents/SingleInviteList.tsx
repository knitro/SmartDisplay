...
import { InvitedToShoppingList } from '../../interfaces/UserShoppingLists';
...
const SingleInviteList: React.FC<Current_Props> = (props : Current_Props) => {
...
export default SingleInviteList;
